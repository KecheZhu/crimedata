...
crime17 <- read_csv("data\\crime_17.csv", show_col_types = FALSE)
crime18 <- read_csv("data\\crime_18.csv", show_col_types = FALSE)
crime19 <- read_csv("data\\crime_19.csv", show_col_types = FALSE)
crime20 <- read_csv("data\\crime_20.csv", show_col_types = FALSE)
crime21 <- read_csv("data\\crime_21.csv", show_col_types = FALSE)
covid <- read_csv("data\\cases-by-day.csv", show_col_types = FALSE)
park_crime <- read_csv("data\\park_crime.csv", show_col_types = FALSE)
